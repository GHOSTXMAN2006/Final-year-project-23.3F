...
{
    public partial class frmStorekeeperStockDamage : Form
    {
        ...
        public frmStorekeeperStockDamage()
        {
            InitializeComponent();
        }
        ...
        {
            frmAddUpdateStockDamage addUpdateStockDamage = new frmAddUpdateStockDamage();

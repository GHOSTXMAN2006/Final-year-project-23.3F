...
{
    public partial class frmStorekeeperPaymentVouchers : Form
    {
        ...
        public frmStorekeeperPaymentVouchers()
        {
            InitializeComponent();
        }
        ...
        {
            frmAddUpdatePaymentVoucher addUpdatePaymentVoucher = new frmAddUpdatePaymentVoucher();

            addUpdatePaymentVoucher.Show();
        }
